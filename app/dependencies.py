...
async def get_current_user(token: str = Depends(oauth2_scheme), db: Session = Depends(get_db)):
    ...
    This function is a dependency that can be injected into any protected endpoint.
    """
    ...
    # FastAPI will automatically handle the conversion to the response_model type
    return user
